...
| Do | Don't |
|----|-------|
| Label framing `INSTITUTIONAL_MODEL` | Claim religious authority or divine mandate |
| Use apostles/messiah as **modeling analogs** | Present analogs as worship targets |
...
## Language rules (shared with ai-native-gov / Errorlogy)
...
| Engine math (μ/α/PNO) | [errorlogy/errorlogy](https://github.com/errorlogy/errorlogy) |
| Streams / politifi | [politic-bar](https://github.com/errorlogy/politic-bar) |
...
- Commit secrets or unpublished personal corpus without explicit review
- Copy `errorlogy_unified_taxonomy_v16.json` into this repo
- Merge politic-bar v0.6 taxonomy with v16
- Present INSTITUTIONAL_MODEL outputs as legal or theological verdicts
