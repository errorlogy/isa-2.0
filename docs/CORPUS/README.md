...
| Last Testament artifact | [`artifacts/POSLEDNIY_ZAVET.md`](artifacts/POSLEDNIY_ZAVET.md) | RU primary; EN companion [`artifacts/POSLEDNIY_ZAVET.en.md`](artifacts/POSLEDNIY_ZAVET.en.md) |
